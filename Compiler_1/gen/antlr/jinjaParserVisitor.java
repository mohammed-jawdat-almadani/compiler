...
public interface jinjaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link jinjaParser#code_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCode_block(jinjaParser.Code_blockContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link jinjaParser#body}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBody(jinjaParser.BodyContext ctx);
	/**
	 * Visit a parse tree produced by {@link jinjaParser#contents}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContents(jinjaParser.ContentsContext ctx);
	/**
	 * Visit a parse tree produced by {@link jinjaParser#html_element}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtml_element(jinjaParser.Html_elementContext ctx);
}