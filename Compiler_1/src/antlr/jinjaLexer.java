// Generated from D:/UY Things/Compiler/Compiler_1/src/antlr/jinjaLexer.g4 by ANTLR 4.13.2
package antlr;
...
public class jinjaLexer extends Lexer {
	...
	public static String[] modeNames = {
		"DEFAULT_MODE", "EXPR_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"TEXT", "COMMENT", "WS", "BLOCK_START", "VAR_START", "WS_EXPR", "BLOCK_END", 
			"VAR_END", "IF", "ELIF", "ELSE", "ENDIF", "FOR", "IN", "END_FOR", "SET", 
			"WHILE", "END_WHILE", "ADD", "SUB", "MUL", "DIV", "EQUALS", "EQ", "NEQ", 
			"GT", "LT", "GTEQ", "LTEQ", "LP", "RP", "DOT", "ID", "INT", "DOUBLE", 
			"STRING", "BOOL", "ESC"
		};
	}
