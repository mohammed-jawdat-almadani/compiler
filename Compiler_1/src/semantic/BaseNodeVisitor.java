...
public abstract class BaseNodeVisitor<T> implements NodeVisitor<T> {
    ...
    @Override
    public T visitHtmlAttribute(HtmlAttribute n) {
        return defaultVisit(n);
    }

    @Override
    public T visitHtmlChardata(HtmlChardata n) {
        return defaultVisit(n);
    }

    @Override
    public T visitHtmlComment(HtmlComment n) {
        return defaultVisit(n);
    }

    @Override
    public T visitScript(Script n) {
        return defaultVisit(n);
    }

    @Override
    public T visitStyle(Style n) {
        return defaultVisit(n);
    }
    ...
    @Override
    public T visitAssignmentStatement(AssignmentStatement n) {
        return defaultVisit(n);
    }
    ...
    public T visitIfStatement(IfStatement n) {
        ...
        if (n.elifBlocks != null) {
            for (ElifStatement e : n.elifBlocks) {
                visit(e);
            }
        }
    ...
    @Override
    public T visitBlockStatement(ast.jinja.BlockStatement n) {
        for (Node c : n.body) {
            visit(c);
        }
