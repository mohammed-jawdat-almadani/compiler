...
public class htmlParser extends Parser {
	...
	public static final int
		HTML_COMMENT=1, SCRIPTLET=2, SEA_WS=3, SCRIPT_OPEN=4, STYLE_OPEN=5, TAG_OPEN=6, 
		HTML_TEXT=7, TAG_CLOSE=8, TAG_SLASH_CLOSE=9, TAG_SLASH=10, TAG_EQUALS=11, 
		TAG_NAME=12, TAG_WHITESPACE=13, SCRIPT_BODY=14, SCRIPT_SHORT_BODY=15, 
		STYLE_BODY=16, STYLE_SHORT_BODY=17, ATTVALUE_VALUE=18, ATTRIBUTE=19;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "HTML_COMMENT", "SCRIPTLET", "SEA_WS", "SCRIPT_OPEN", "STYLE_OPEN", 
